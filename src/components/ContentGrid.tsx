            ...
            <PopoverContent className="w-[280px] p-4 bg-slate-900 border-slate-700">
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <h4 className="font-medium text-emerald-400">Filters</h4>
      ...
      {isLoading ? (
        ...
        <Tabs defaultValue="all" onValueChange={(value) => setActiveCategory(value as 'all' | ContentCategory)}>
          <TabsList className="w-full flex justify-center gap-4 mb-12">
            <TabsTrigger 
              value="all" 
              className="min-w-[120px] data-[state=active]:bg-emerald-600 data-[state=active]:text-white px-8 font-oswald flex flex-col items-center py-3 text-base rounded-md transition-all duration-200 hover:bg-slate-700/50 text-slate-300"
            >
