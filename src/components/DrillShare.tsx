...
const CoachingApp = () => {
        ...
        <CardHeader>
          <div className="flex justify-between items-start">
            <div className="flex items-center gap-2">
              <CardTitle className="text-lg text-emerald-400">{video.title}</CardTitle>
              <Button 
                onClick={handleEdit}
                variant="ghost" 
                size="sm"
            ...
            <Badge variant="outline" className="bg-slate-700 text-emerald-300 border-emerald-400/30">
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4">
        <div className="bg-slate-800 rounded-lg w-full max-w-2xl p-6">
          <h2 className="text-xl font-bold mb-4 text-emerald-400">Edit Content</h2>
  ...
  const AddContentForm = ({ onSubmit }) => {
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4">
        <div className="bg-slate-800 rounded-lg w-full max-w-2xl p-6">
          <h2 className="text-xl font-bold mb-4 text-emerald-400">Add New Content</h2>
    ...
    <div className="h-screen flex flex-col bg-slate-900 text-slate-100">
      ...
      <Tabs defaultValue="hitting" className="flex-1 flex flex-col">
        <TabsList className="w-full justify-start px-4 bg-slate-800 border-b border-slate-700">
          ...
          <TabsTrigger value="other" className="data-[state=active]:bg-emerald-600 data-[state=active]:text-white">Other</TabsTrigger>
        </TabsList>
